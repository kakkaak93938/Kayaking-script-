...
do
	...
	do
		...
		do
			...
			do
				...
				do
					...
					do
						...
						function v25(p4, p5, p6, p7, p8, p9, p10)
							...
							if not v378 then
								...
								MouseButton1Click:Connect(function() u385:Destroy() end)
								...
								local u408 = p9
								local u409 = p4
								MouseButton1Click2:Connect(function() u408(u386) end)
								...
								MouseButton1Click3:Connect(function() p10(); u412:Destroy() end)
								u24(Frame)
								return
							end
							v378:Destroy()
					...
					do
						...
						do
							...
							do
								...
								spawn(function()
									...
									if GunDrop then if u17 then u49(GunDrop) end end
								end)
							end
														...
														Died:Connect(function()
															if u435.Backpack:FindFirstChild("Gun") or u436:FindFirstChild("Gun") then
																task.delay(0.8, function()
																	...
																	if GunDrop then if u17 then u52(GunDrop) end end
																end)
															end
														end)
													end
												...
												Died:Connect(function()
													if u442.Backpack:FindFirstChild("Gun") or u443:FindFirstChild("Gun") then
														task.delay(0.8, function()
															...
															if GunDrop then if u17 then u59(GunDrop) end end
														end)
													end
												end)
											end
							...
							function v68()
								for _, player in ipairs(u67:GetPlayers()) do
									if player.Character then
										...
										if RuzHub_ESP then RuzHub_ESP:Destroy() end
									end
								end
								t2 = {}
								n4 = 0
						...
						do
							...
							local function u73(p20)
								...
								if v446 then
									...
									if v448:find("murd") then return "Murderer" end
									if v448:find("sheriff") or v448:find("gun") then return "Sheriff" end
									if v448:find("hero") then s1 = "Hero" end
								end
								return s1
							end
											...
											if Humanoid and Humanoid.Health > 0 then
												...
												if HumanoidRootPart then
													...
													if not v466 then
														...
														elseif v477 or v476 then v479 = true end
													elseif v476 then v479 = true end
									...
									if v488 then
										...
										if v489 then
											...
											if u13 then
												...
												if ok and result then v492 = v492 + result * 0.9 end
											end
						...
						local function u97()
							...
							local totalTime = (travelTime * 0.2) + (ping * 1.15)
							...
							if targetHum.FloorMaterial == Enum.Material.Air then
								targetPos = targetPos - Vector3.new(0, 0.5 * workspace.Gravity * totalTime^2, 0) * 0.3
							end

							if targetPos.Y < targetRoot.Position.Y - 3 and targetHum.FloorMaterial ~= Enum.Material.Air then
							...
							local startPos = HumanoidRootPart.Position + Vector3.new(0, 2.1, 0)
						...
						local function u96()
							...
							local workspace = game:GetService("Workspace")
							if targetHum.FloorMaterial == Enum.Material.Air then
								targetPos = targetPos - Vector3.new(0, 0.5 * workspace.Gravity * totalTime^2, 0) * 0.5
							end
					...
					do
						...
						function u104()
							...
							if u101.MouseBehavior ~= Enum.MouseBehavior.LockCenter then
								...
								local n8 = 1; local n9 = 5; local n10 = 1
								g539 = nil
								if false then
									if true then g539 = true end
								elseif not (n8 <= n9) then g539 = true end
								if not g539 then
									if not g539 then
										repeat
											while true do
												...
												u103.RenderStepped:Wait()
												n8 = n8 + n10
												if n10 > 0 then break end
												if not (n9 <= n8) then g539 = true end
												if g539 then break end
											end
											if g539 then break end
										until not (n8 <= n9)
									end
						...
						function u110()
							local v540 = nil; local RenderStepped = nil; local v542 = nil; local v543 = nil
							...
							if not v547 then
								...
								local n11 = 1; local n12 = 7; local n13 = 1
								g566 = nil
								if false then
									if true then g566 = true end
								elseif not (n11 <= n12) then g566 = true end
								if not g566 then
									if not g566 then
										repeat
											while true do
												...
												v542:Wait()
												n11 = n11 + n13
												if n13 > 0 then break end
												if not (n12 <= n11) then g566 = true end
												if g566 then break end
											end
											if g566 then break end
										until not (n11 <= n12)
									end
							...
							local _pcall = pcall; local u574 = Humanoid
							pcall(function() u574:ChangeState(Enum.HumanoidStateType.Jumping) end)
							task.wait(0.12)
							if not v547 then
								...
								for i = 1, 5 do
									...
									v543 = u109.RenderStepped; v543:Wait()
								end
							else
								local Unit = Vector3.new(CFrame3.LookVector.X, 0, CFrame3.LookVector.Z).Unit
								local new = Vector3.new
								...
								local n14 = 1; local n15 = 5; local n16 = 1
								if false then
									if true then g590 = true end
								elseif not (n14 <= n15) then g590 = true end
								if not g590 then
									if not g590 then
										repeat
											while true do
												...
												CFrame4 = u109.RenderStepped; CFrame4:Wait()
												n14 = n14 + n16
												if n16 > 0 then break end
												if not (n15 <= n14) then g590 = true end
												if g590 then break end
											end
											if g590 then break end
										until not (n14 <= n15)
									end
				...
				do
					local t7 = {}
					local t8 = { name = "Red", id = "98490421374360", color = Color3.fromRGB(200, 50, 50) }
					local t9 = { name = "Pink", id = "95000769820905", color = Color3.fromRGB(220, 100, 180) }
					local t10 = { name = "Pink 2", id = "82988835868087", color = Color3.fromRGB(200, 80, 160) }
					local t11 = { name = "Green", id = "5036205687", color = Color3.fromRGB(50, 180, 80) }
					local t12 = { name = "Black", id = "80807192441609", color = Color3.fromRGB(30, 30, 30) }
					local t13 = { name = "Cosmic", id = "77816282467771", color = Color3.fromRGB(80, 40, 160) }
					local t14 = { name = "Yellow", id = "2669948520", color = Color3.fromRGB(220, 190, 40) }
					t7[1] = t8; t7[2] = t9; t7[3] = t10; t7[4] = t11; t7[5] = t12; t7[6] = t13; t7[7] = t14
					local u140 = nil; local u141 = false
					local u142 = Lighting;
					(function()
						local Sky = u142:FindFirstChildOfClass("Sky")
						if Sky then
							u140 = { SkyboxBk = Sky.SkyboxBk, SkyboxDn = Sky.SkyboxDn, SkyboxFt = Sky.SkyboxFt, SkyboxLf = Sky.SkyboxLf, SkyboxRt = Sky.SkyboxRt, SkyboxUp = Sky.SkyboxUp }
						end
					end)()
					local u143 = Lighting
					local u144 = v18
					...
					function v145()
						...
						if u140 then
							...
							for k, v in pairs(u140) do Sky[k] = v end
						end
						u141 = false
					end
					...
					u150 = t7
					u151 = v21
					local u152 = false; local u153 = nil
					...
					function u156(p28)
						u152 = p28
						if not p28 then
							if u153 then u153:Disconnect(); u153 = nil end
							return
						end
						if u153 then u153:Disconnect() end
				...
				local u158 = LocalPlayer; local u159 = v18; local u160 = Workspace
									...
									if Character4 then
										...
										if not Humanoid2 or not Humanoid2.Sit then
											...
											if Character4:FindFirstChildWhichIsA("BasePart") then
												local u668 = RootPart; local u669 = Character
												local function u670(p30, p31, p32)
													u668.CFrame = CFrame.new(p30.Position) * p31 * p32
													local _pcall = pcall; local u900 = p30; local u901 = p31; local u902 = p32
													pcall(function() u669:SetPrimaryPartCFrame(CFrame.new(u900.Position) * u901 * u902) end)
												...
												if getgenv().RuzOldPos then
													...
													repeat
														...
														local _pcall = pcall; local u677 = Character
														pcall(function() u677:SetPrimaryPartCFrame(getgenv().RuzOldPos * CFrame.new(0, 0.5, 0)) end)
				...
				local t15 = { GlobalShadows = Lighting.GlobalShadows, Brightness = Lighting.Brightness, Ambient = Lighting.Ambient, OutdoorAmbient = Lighting.OutdoorAmbient }
				local t16 = {}
				...
				local u179 = Lighting; local u180 = t15; local u181 = TextLabel; local u182 = v18
				...
				function v183()
					...
					for k, v in pairs(t16) do
						if k and k.Parent then
							local _pcall = pcall; local u699 = v; local u700 = k
							pcall(function() for k2, v2 in pairs(u699) do u700[k2] = v2 end end)
						end
					end
					t16 = {}
					u181.Visible = false
				...
				local t18 = { name = "Neon Cyan", id = "11770890197" }
				local t19 = { name = "Electric Purple", id = "11770691141" }
				local t20 = { name = "Precision Dot", id = "10878218308" }
				local t21 = { name = "Aim Cross", id = "10891594349" }
				local t22 = { name = "Blue Spec", id = "11720475063" }
				local t23 = { name = "Circle Dot", id = "10831379335" }
				local t24 = { name = "Green Hit", id = "8375241602" }
				t17[1] = t18; t17[2] = t19; t17[3] = t20; t17[4] = t21; t17[5] = t22; t17[6] = t23; t17[7] = t24
			end

			u198 = false; u199 = false; id = t17[1].id; u201 = nil; u202 = nil
			...
			if RuzHub_BtnLayer then RuzHub_BtnLayer:Destroy() end
			...
			function u218(p35)
				local u740 = nil; local p36Position = nil; local Position = nil
				local InputBegan = p35.InputBegan; local u744 = p35
				...
				local InputChanged = p35.InputChanged; local u746 = p35
			...
			function v220(p38, p39, p40, p41, p42)
				if u219[p38] then u219[p38].btn:Destroy(); u219[p38] = nil end
				...
				UIStroke.Color = p41; UIStroke.Thickness = 1.3; UIStroke.Transparency = 0.5; UIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
			...
			function u222(p43, p44)
				...
				local v759 = YOffset * 0.55; local v760 = math.floor(v759)
				...
				local spawn = task.spawn; local u765 = ImageLabel
				spawn(function()
			...
			local u226 = t25; local u227 = v220; local u228 = t26; local u229 = uDim2_2; local u230 = v18; local u231 = v115
			...
			local u233 = t25; local u234 = v220; local u235 = t26; local u236 = uDim2_2; local u237 = v18; local u238 = v115
		...
		local u240 = t25; local u241 = v220; local u242 = t26; local u243 = uDim2_2
		...
		local u245 = t25; local u246 = v220; local u247 = t26; local u248 = uDim2; local u249 = v78; local u250 = v68; local u251 = v18
		...
		local u253 = t25; local u254 = v220; local u255 = t26; local u256 = uDim2
		...
		local u258 = t25; local u259 = v220; local u260 = t26; local u261 = uDim2; local u262 = v18
		...
		local u264 = t25; local u265 = v220; local u266 = t26; local u267 = uDim2; local u268 = v125; local u269 = v18
	...
	local u271 = t25; local u272 = v220; local u273 = t26; local u274 = uDim2
	...
	local u277 = t25; local u278 = v220; local u279 = t26; local u280 = uDim2
	...
	local u282 = t25; local u283 = v220; local u284 = t26; local u285 = uDim2
	...
	local u288 = t25; local u289 = v220; local u290 = t26; local u291 = uDim2
	...
	local u295 = t25; local u296 = LocalPlayer; local u297 = UserInputService; local u298 = Workspace; local u299 = Players
	...
	}):Section({ Title = "RuzHub", Opened = true })

	v301 = v300:Tab({ Title = "Main", Icon = "zap" })
	v302 = v300:Tab({ Title = "ESP", Icon = "eye" })
...
v301:Button({
	...
	Callback = function()
		...
		if not RuzSkyboxPicker then
			...
			MouseButton1Click:Connect(function() u633:Destroy() end)
			...
			MouseButton1Click4:Connect(function() u149(); u639:Destroy() end)
				...
				MouseButton1Click5:Connect(function()
					...
					for _, child in ipairs(u652:GetChildren()) do
						if child:IsA("TextButton") then
							...
							if UIStroke3 then UIStroke3.Thickness = 1; UIStroke3.Color = Color3.fromRGB(80, 80, 80) end
...
local t30 = { Title = "Restore Default Sky" }
local u310 = v145
function t30.Callback() u310() end
v301:Button(t30)
...
local u313 = v18; local u314 = UserInputService

function t31.Callback(p69)
	u198 = p69
	if not p69 then
		local RuzCrosshairDisplay = game.CoreGui:FindFirstChild("RuzCrosshairDisplay")
		if RuzCrosshairDisplay then RuzCrosshairDisplay:Destroy(); u201 = nil end
		if u202 then u202:Disconnect(); u202 = nil end
...
v301:Button({
	...
	Callback = function()
		...
		if not RuzCursorPicker then
			...
			MouseButton1Click:Connect(function() u715:Destroy() end)
			...
			Instance.new("UICorner", TextBox).CornerRadius = UDim.new(0, 6)
			Instance.new("UIStroke", TextBox).Color = Color3.fromRGB(80, 80, 80)
			local FocusLost = TextBox.FocusLost; local u718 = TextBox
			FocusLost:Connect(function(p70)
				if p70 and u718.Text ~= "" then
					id = u718.Text
					if u198 and u201 then u201.Image = "rbxassetid://" .. u718.Text end
					u718.Text = ""
				end
			end)
			...
			local MouseButton1Click6 = TextButton7.MouseButton1Click; local u723 = TextButton7
			...
			for i, v in ipairs(u211) do
				...
				local u737 = v; local u738 = ScreenGui
				MouseButton1Click7:Connect(function()
					id = u737.id
					if u198 and u201 then u201.Image = "rbxassetid://" .. u737.id end
					u738:Destroy()
				end)
			end
...
local u322 = v25; local u323 = CurrentCamera; local u324 = v18
...
local u330 = v18
function t37.Callback(p74) u156(p74) end
v301:Toggle(t37)

local t38 = { Title = "Auto Ping Prediction", Description = "Adds ping offset to shoot and throw", Default = false }
local u332 = v18
function t38.Callback(p75) u13 = p75 end
v301:Toggle(t38)

-- ===== SHADOW LOCK TOGGLE (زر تثبيت الأزرار) =====
local t_lock = {
    Title = "🔒 Lock Draggable Buttons",
    Description = "Fix buttons in place after moving them",
    Default = false,
}
...
local u334 = v25; local u335 = v18
function t39.Callback()
	u334("Speed Glitch", 50, 600, n2, 10, function(p76) n2 = p76 end, function() n2 = 200 end)
end
v301:Button(t39)
...
local u337 = v78; local u338 = v68; local u339 = v18
...
local t46 = { Title = "Dropped Gun ESP", Description = "Highlight and label when a gun is on the map", Default = true }
local u351 = v18
...
local t47 = { Title = "Murderer Color", Default = Color3.fromRGB(255, 40, 40) }
local u353 = t4
function t47.Callback(p85) u353.Murderer = p85 end
v302:ColorPicker(t47)

local t48 = { Title = "Sheriff Color", Default = Color3.fromRGB(40, 130, 255) }
local u355 = t4
function t48.Callback(p86) u355.Sheriff = p86 end
v302:ColorPicker(t48)

local t49 = { Title = "Hero Color", Default = Color3.fromRGB(255, 215, 0) }
local u357 = t4
function t49.Callback(p87) u357.Hero = p87 end
v302:ColorPicker(t49)

local t50 = { Title = "Innocent Color", Default = Color3.fromRGB(0, 220, 0) }
local u359 = t4
